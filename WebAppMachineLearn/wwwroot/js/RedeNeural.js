...
class RedeNeural {
    constructor(i_nodes, h_nodes, o_nodes) {
        ...
        //Entrada para camada oculta - nova matriz que corresponde ao número de neurônios escondidos por 1 coluna 
        this.bias_ih = new Matrix(this.h_nodes, 1);
        this.bias_ih.randomize();
        //A mesma coisa da camada oculta para a de saída
        this.bias_ho = new Matrix(this.o_nodes, 1);
        this.bias_ho.randomize();

        //imprimindo em console os neurônios e a saída
        //this.bias_ih.print();
        //this.bias_ho.print();
